...
public class TestApp {
    public static void main(String[] args) {
        new Student("0001", "Alice", "alice@example.com", "password1", "CS101", LocalDate.of(2022, 9, 1));
        new Student("0002", "Charlie", "charlie@example.com", "mypassword", "CS102", LocalDate.of(2023, 1, 15));
